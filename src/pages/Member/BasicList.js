    ...
    const extraContent = (
      <div className={styles.extraContent}>
        <RadioGroup defaultValue="all">
          ...
          <RadioButton value="progress">Đã xác thực</RadioButton>
          <RadioButton value="waiting">Chưa xác thực</RadioButton>
        </RadioGroup>
        <Search
      ...
      <PageHeaderWrapper>
        <div className={styles.standardList}>
          <Card bordered={false}>
            <Row>
              <Col sm={8} xs={24}>
                <Info title="Thành viên" value="8" bordered />
              </Col>
              <Col sm={8} xs={24}>
                <Info title="Đã xác thực" value="32" bordered />
              </Col>
              <Col sm={8} xs={24}>
                <Info title="Đang sử dụng dịch vụ" value="24" />
              </Col>
            </Row>
          </Card>
          <Card
